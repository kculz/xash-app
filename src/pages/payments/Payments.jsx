  ...
  const paymentServices = [
    {
      ...
      color: 'bg-green-600',
      features: ['Direct recharge', 'Voucher purchase', 'All networks'],
      popular: true
    },
    {
      title: 'Bundles',
      description: 'Data bundles and internet packages',
      icon: Wifi,
      path: '/payments/bundles',
      color: 'bg-blue-600',
      features: ['Daily bundles', 'Weekly packages', 'Monthly plans'],
      popular: true
    },
    {
      title: 'Electricity',
      description: 'ZESA token purchases',
      icon: Zap,
      path: '/payments/electricity',
      color: 'bg-yellow-600',
      features: ['Token purchase', 'Account verification', 'Instant delivery'],
      popular: false
    },
    {
      title: 'Transfer',
      ...
      color: 'bg-purple-600',
      features: ['Instant transfer', 'Secure payments', 'No fees'],
      popular: true
    }
  ];
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      if (historyResponse.success && historyResponse.data) {
        recentTransactions = historyResponse.data.length;
        // Get last 3 transactions for recent activity
        recentActivityData = historyResponse.data.slice(0, 3).map(transaction => ({
    ...
    <div>
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
        <div>
          ...
          <p className="text-gray-400">Manage all your payment services in one place</p>
        </div>
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-gray-400 text-sm">Complete payment solutions</span>
        </div>
                  ...
                  >
                    ...
                    <div className="text-right">
                      <p className={`font-semibold ${
                        ...
                        {activity.type === 'transfer' ? '-' : '+'}{formatCurrency(activity.amount, activity.currency)}
                      </p>
